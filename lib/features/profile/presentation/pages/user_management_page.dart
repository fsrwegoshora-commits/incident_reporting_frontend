...
import 'package:incident_reporting_frontend/features/profile/presentation/pages/register_special_user_tab.dart';
  ...
  Future<Map<String, dynamic>> _fetchUsers() async {
    ...
    try {
      final response = await api.getUsers(
          ...
          key: _searchQuery.isEmpty ? null : _searchQuery,
          isActive: true, sortBy: 'createdAt', sortDirection: 'DESC');
