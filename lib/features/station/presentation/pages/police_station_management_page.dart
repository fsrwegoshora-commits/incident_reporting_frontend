...
import 'package:incident_reporting_frontend/features/station/presentation/pages/police_station_form.dart';
import 'package:incident_reporting_frontend/features/police/presentation/pages/police_officers_by_station_page.dart';
import 'package:incident_reporting_frontend/features/station/presentation/pages/traffic_checkpoints_by_station_page.dart';
...
import 'package:incident_reporting_frontend/features/shift/presentation/pages/officer_shift_management_page.dart';
...
class _PoliceStationManagementScreenState extends State<PoliceStationManagementScreen>
  ...
  Future<Map<String, dynamic>> _fetchPoliceStations() async {
    ...
    try {
      print('Fetching police stations, page: $_currentPage');

      final response = await api.getPoliceStations(
          page: _currentPage, size: _pageSize,
          key: _searchQuery.isEmpty ? null : _searchQuery, isActive: true);
      ...
      final policeStations = response['data'] ?? [];
  ...
  void _deletePoliceStation(String uid) async {
    ...
    if (confirm == true) {
      try {
        final response = await api.deletePoliceStation(uid);
