...
class _OfficerShiftFormState extends State<OfficerShiftForm> {
        ...
        Future<void> _fetchAvailableOfficers() async {
                ...
                try {
                        ...
                        List<Map<String, dynamic>> availableOfficers = List<Map<String, dynamic>>.from(response['data'] ?? []);
        ...
        Future<void> _fetchAvailableCheckpoints() async {
                try {
                        ...
                        setState(() {
                                _availableCheckpoints = List<Map<String, dynamic>>.from(response['data'] ?? []);
        ...
        Future<void> _submitForm() async {
                if (_formKey.currentState!.validate()) {
                        ...
                        try {
                                ...
                                final response = await _api.saveShift(dto);
                                ...
                                if (response['status'] != 'Success') {
                                        _showModernSnackBar(
                                                response['message'] ?? "Failed to save shift",
                                                isSuccess: false,
                                        );
                                } else {
                                        _showModernSnackBar(
                                                response['message'] ?? "Shift saved successfully",
                                                isSuccess: true,
                                        );
                        ...
                        child: SingleChildScrollView(
                                ...
                                child: Column(
                                        ...
                                        children: [
                                                ...
                                                AppButton(
                                                  label: widget.existingShift == null ? 'Assign Shift' : 'Update Shift',
